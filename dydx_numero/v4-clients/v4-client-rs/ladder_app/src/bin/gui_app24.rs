// ladder_app/src/bin/gui_app23.rs
//
// gui_app22, but with explicit mouse-tuned plots:
//  - Drag pans (X & Y).
//  - Scroll / trackpad zooms (X & Y).
//  - Boxed zoom enabled on candles.
...
//   cargo run -p ladder_app --bin gui_app23
...
impl MyApp {
    ...
    fn ui_candles(&mut self, ui: &mut egui::Ui) {
        ...
        // ---- candles plot (FILLED BODIES, WIDTH RELATIVE TO TF, mouse-tuned) ----
