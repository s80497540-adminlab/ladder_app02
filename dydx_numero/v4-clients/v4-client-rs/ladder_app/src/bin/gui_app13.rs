// ladder_app/src/bin/gui_app13.rs
//
...
//  - REAL testnet market BUY / SELL buttons
//  - Scrollable UI so you don’t need to zoom just to reach the trading panel
//
// Run:
//   export DYDX_TESTNET_MNEMONIC='...'
//   cargo run -p ladder_app --bin gui_app13
