...
struct ComboApp {
    ...
    ticker_tx: watch::Sender<String>, // new: send live ticker changes
...
impl ComboApp {
    ...
    fn ui_live(&mut self, ui: &mut egui::Ui) {
        ...
        // candles_h not used directly, but layout already uses available_height
        let _ = candles_h;
    }
...
fn main() {
    ...
    let app = ComboApp::new(book_rx, replay_data, ticker_tx.clone());
