// ladder_app/src/bin/gui_app20.rs
//
// Same as gui_app19, but with FILLED candlesticks instead of hollow bodies.
//
...
//   cargo run -p ladder_app --bin gui_app20
...
impl MyApp {
    ...
    fn ui_candles(&mut self, ui: &mut egui::Ui) {
        ...
        // ---- candles plot (NOW WITH FILLED BODIES) ----
