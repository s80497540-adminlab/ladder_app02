// ladder_app/src/bin/gui_app22.rs
//
// gui_app21, but:
//  - Mouse has full control over chart position (X and Y) via egui_plot interactions.
//  - Removed manual x_pan/x_zoom controls and bounds forcing.
//  - All previously requested features kept:
//      * Themes (5 palettes)
//      * Ticker dropdown (ETH-USD / BTC-USD / SOL-USD)
//      * Unix vs Local time toggle
//      * Volume histogram
//      * RSI
//      * Scrollable layout
...
//   cargo run -p ladder_app --bin gui_app22
...
use egui_plot::{GridMark, HLine, Line, Plot, PlotPoints, Polygon, VLine};
...
impl MyApp {
    ...
    fn ui_candles(&mut self, ui: &mut egui::Ui) {
        ...
        // ---- candles plot (FILLED BODIES, WIDTH RELATIVE TO TF, mouse controls camera) ----
