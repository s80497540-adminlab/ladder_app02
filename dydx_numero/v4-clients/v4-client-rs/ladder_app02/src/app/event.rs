...
pub enum FeedEvent {
    ...
    MarketPrice {
        ...
        open_interest_raw: String,
        volume_24h_raw: String,
        price_change_24h_raw: String,
        trades_24h_raw: String,
        next_funding_rate_raw: String,
        clob_pair_id_raw: String,
        initial_margin_fraction_raw: String,
        maintenance_margin_fraction_raw: String,
        tick_size_raw: String,
        step_size_raw: String,
        step_base_quantums_raw: String,
        subticks_per_tick_raw: String,
        market_type_raw: String,
        atomic_resolution_raw: String,
        quantum_conversion_exponent_raw: String,
        open_interest_lower_cap_raw: String,
        open_interest_upper_cap_raw: String,
        base_open_interest_raw: String,
        default_funding_rate_1h_raw: String,
    },
    MarketList {
