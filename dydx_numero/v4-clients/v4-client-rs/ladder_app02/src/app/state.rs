...
pub struct AppState {
    ...
    pub open_interest_raw: String,
    pub volume_24h_raw: String,
    pub price_change_24h_raw: String,
    pub trades_24h_raw: String,
    pub next_funding_rate_raw: String,
    pub clob_pair_id_raw: String,
    pub initial_margin_fraction_raw: String,
    pub maintenance_margin_fraction_raw: String,
    pub tick_size_raw: String,
    pub step_size_raw: String,
    pub step_base_quantums_raw: String,
    pub subticks_per_tick_raw: String,
    pub market_type_raw: String,
    pub atomic_resolution_raw: String,
    pub quantum_conversion_exponent_raw: String,
    pub open_interest_lower_cap_raw: String,
    pub open_interest_upper_cap_raw: String,
    pub base_open_interest_raw: String,
    pub default_funding_rate_1h_raw: String,
...
impl Default for AppState {
    fn default() -> Self {
        ...
        Self {
            ...
            open_interest_raw: String::new(),
            volume_24h_raw: String::new(),
            price_change_24h_raw: String::new(),
            trades_24h_raw: String::new(),
            next_funding_rate_raw: String::new(),
            clob_pair_id_raw: String::new(),
            initial_margin_fraction_raw: String::new(),
            maintenance_margin_fraction_raw: String::new(),
            tick_size_raw: String::new(),
            step_size_raw: String::new(),
            step_base_quantums_raw: String::new(),
            subticks_per_tick_raw: String::new(),
            market_type_raw: String::new(),
            atomic_resolution_raw: String::new(),
            quantum_conversion_exponent_raw: String::new(),
            open_interest_lower_cap_raw: String::new(),
            open_interest_upper_cap_raw: String::new(),
            base_open_interest_raw: String::new(),
            default_funding_rate_1h_raw: String::new(),
